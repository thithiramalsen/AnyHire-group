        ...
        try {
            ...
            if (response.data) {
                ...
                const data = {
                    ...
                    ticketsByStatus: response.data.ticketsByStatus || [],
                    ticketsByCategory: response.data.ticketsByCategory || [],
                    ticketsGrowth: response.data.ticketsGrowth || []
                };
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <AnalyticsCard
                    title="Open Tickets"
                    value={analyticsData.openTickets.toLocaleString()}
                    icon={Clock}
                ...
                <AnalyticsCard
                    ...
                    value={`${analyticsData.averageResponseTime.toFixed(1)}h`}
                    icon={TrendingUp}
